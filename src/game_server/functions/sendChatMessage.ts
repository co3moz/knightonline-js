...
export function SendMessageToPlayerFromPlayer(socket: IGameSocket, fromSocket: IGameSocket, type: ChatMessageType, message: string) {
  socket.send([
...
export function SendPlayerMessageToRegion(socket: IGameSocket, message: string) {
