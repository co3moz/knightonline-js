...
const CHARACTER_ITEM_SLOTS = [ItemSlot.HEAD, ItemSlot.BREAST, ItemSlot.SHOULDER, ItemSlot.RIGHTHAND, ItemSlot.LEFTHAND, ItemSlot.LEG, ItemSlot.GLOVE, ItemSlot.FOOT];

export const ALLCHAR_INFO_REQ: IGameEndpoint = async function (socket: IGameSocket, body: Queue, opcode: number) {
